            ...
            >
              <div style={{ padding: 'clamp(2rem, 5vw, 3.5rem)', display: 'grid', gap: '3rem', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', alignItems: 'start' }}>
                <div>
                  ...
                  <Link
                    href="/contact"
                    style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', background: 'linear-gradient(135deg, #1B4FD8 0%, #2563EB 100%)', color: '#fff', fontFamily: "var(--font-barlow), 'Barlow', sans-serif", fontWeight: 600, fontSize: '0.875rem', padding: '0.75rem 1.5rem', borderRadius: '8px', textDecoration: 'none', boxShadow: '0 0 20px rgba(27,79,216,0.35)' }}
                  >
        ...
        <section style={{ padding: '6rem 0' }}>
          <div className="container mx-auto px-4 lg:px-8">
            <div style={{ maxWidth: '60rem', margin: '0 auto' }}>
              ...
              <h2 style={{ fontFamily: "var(--font-barlow), 'Barlow', sans-serif", fontWeight: 700, fontSize: 'clamp(1.75rem, 4vw, 2.5rem)', color: 'var(--white)', marginBottom: '0.75rem', lineHeight: 1.15 }}>
                ...
                {socials.map((s) => {
                  ...
                  return (
                    <div key={s.platform} className="glass-card" style={{ padding: '1.75rem', transition: 'border-color 0.3s' }}>
                      ...
                      <h3 style={{ fontFamily: "var(--font-barlow), 'Barlow', sans-serif", fontWeight: 600, fontSize: '1rem', color: 'var(--white)', marginBottom: '0.25rem' }}>{s.platform}</h3>
                      ...
                      <a href={s.url} className="animated-link" style={{ fontSize: '0.85rem', fontFamily: "var(--font-barlow), 'Barlow', sans-serif", fontWeight: 500, display: 'inline-flex', alignItems: 'center', gap: '0.35rem' }}>
        ...
        <section style={{ background: 'var(--navy-mid)', padding: '5rem 0', borderTop: '1px solid var(--border)' }}>
          <div className="container mx-auto px-4 lg:px-8">
            <div style={{ maxWidth: '60rem', margin: '0 auto' }}>
              ...
              <h2 style={{ fontFamily: "var(--font-barlow), 'Barlow', sans-serif", fontWeight: 700, fontSize: 'clamp(1.5rem, 3.5vw, 2.25rem)', color: 'var(--white)', marginBottom: '0.75rem', lineHeight: 1.15 }}>
                ...
                {upcoming.map((a) => (
                  <div key={a.title} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1.5rem', border: '1px solid var(--border)', background: 'rgba(255,255,255,0.02)', borderRadius: '12px', padding: '1.1rem 1.5rem' }}>
                    <div>
                      ...
                      <p style={{ fontFamily: "var(--font-barlow), 'Barlow', sans-serif", fontWeight: 500, fontSize: '0.9rem', color: 'var(--white)' }}>{a.title}</p>
                    </div>
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div style={{ maxWidth: '52rem', margin: '0 auto', textAlign: 'center', border: '1px solid rgba(27,79,216,0.35)', borderRadius: '24px', padding: 'clamp(2.5rem, 5vw, 4rem) clamp(1.5rem, 5vw, 4rem)', background: 'linear-gradient(135deg, rgba(27,79,216,0.1) 0%, rgba(34,211,238,0.05) 100%)', position: 'relative', overflow: 'hidden' }}>
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                <h2 style={{ fontFamily: "var(--font-barlow), 'Barlow', sans-serif", fontWeight: 800, fontSize: 'clamp(1.5rem, 3.5vw, 2.25rem)', color: 'var(--white)', marginBottom: '1rem', lineHeight: 1.1 }}>
