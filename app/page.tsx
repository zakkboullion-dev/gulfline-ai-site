          ...
          <div className="container mx-auto px-4 lg:px-8 mb-10">
            <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
              ...
              <Link
                ...
                style={{ fontFamily: "var(--font-barlow), 'Barlow', sans-serif", fontWeight: 500, fontSize: '0.9rem', whiteSpace: 'nowrap' }}
              >
                View All Services →
              </Link>
            </div>
            ...
            <div className="mb-12">
              ...
              <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
                ...
                <Link
                  href="/portfolio"
                  className="animated-link"
                  style={{ fontFamily: "var(--font-barlow), 'Barlow', sans-serif", fontWeight: 500, fontSize: '0.9rem' }}
                >
                  Full Portfolio →
                </Link>
              </div>
              ...
              {portfolio.map((p) => (
                <div key={p.name} className="glass-card" style={{ padding: '1.75rem', transition: 'border-color 0.3s' }}>
                  ...
                  <a
                    ...
                    className="animated-link"
                    style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', fontSize: '0.875rem', fontFamily: "var(--font-barlow), 'Barlow', sans-serif", fontWeight: 500 }}
                  >
                ...
                <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', justifyContent: 'center' }}>
                  ...
                  <a
                    ...
                    style={{
                      ...
                      border: '1px solid rgba(240,244,255,0.15)',
                      color: 'rgba(240,244,255,0.7)',
                      fontFamily: "var(--font-barlow), 'Barlow', sans-serif", fontWeight: 500, fontSize: '0.95rem',
                      padding: '0.875rem 2rem', borderRadius: '10px',
                      background: 'rgba(255,255,255,0.04)',
                      textDecoration: 'none',
                    }}
